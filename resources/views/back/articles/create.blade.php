                   ...
                   <div class="card-body">
                       <form class="forms-sample" action="{{route('admin.articles.store')}}"  method="post">
                           ...
                           <div class="form-group">
                               ...
                               <input type="text" class="form-control" id="exampleInputName1" name="main_price" value="{{old('main_price')}}" >
                           </div>
                           <div class="form-group">
                               <label for="exampleInputName1">تخفیف</label>
                               <input type="text" class="form-control" id="exampleInputName1" name="suggest_price" value="{{old('suggest_price')}}" >
                           </div>
                           <div class="form-group">
                               <label for="exampleInputName1">اف</label>
                               <input type="text" class="form-control" id="exampleInputName1" name="off_price" value="{{old('off_price')}}" >
                           </div>
                           <div class="form-group">
